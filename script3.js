...
FamilyTree._defaultConfig = function (e) {
            ...
            if (FamilyTree.LAZY_LOADING || this._initialized || (this._setInitialSizeIfNotSet(),
                ...
                this.manager.read(e, this.width(), this.height(), n, t, i, (function (n) {
                    if (!a.notifierUI.show(n.notif) && (!1 !== a.config.lazyLoading || !0 !== e || t === FamilyTree.action.exporting)) {
                        t != FamilyTree.action.exporting && (a.nodes = n.nodes,
                        ...
                        FamilyTree.events.publish("prerender", [a, l]),
                            o = l.content;
                        for (var m = 0; m < n.visibleNodeIds.length; m++) {
                            var p = n.nodes[n.visibleNodeIds[m]]
                                , h = a._get(p.id);
                            FamilyTree.RENDER_LINKS_BEFORE_NODES && (o += a.ui.link(p, a, s, n.bordersByRootIdAndLevel, n.nodes, t)),
                        ...
                        if (FamilyTree.events.publish("render", [a, l]),
                            o = l.content,
                            n = l.res,
                            ...
                            )) : !d || !a.response || d[0] == a.response.viewBox[0] && d[1] == a.response.viewBox[1] && d[2] == a.response.viewBox[2] && d[3] == a.response.viewBox[3] || t !== FamilyTree.action.insert && t !== FamilyTree.action.expand && t !== FamilyTree.action.collapse && t !== FamilyTree.action.update && t !== FamilyTree.action.init ? 0 == g[0].length && (y || (r && r(),
                                FamilyTree.events.publish("redraw", [a]),
    ...
    FamilyTree.prototype.add = function (e) {
        return null == e.id && console.error("Call addNode without id"),
    ...
    FamilyTree.prototype._get = function (e) {
        ...
        if ((this.config.groupDottedLines.length || this.config.dottedLines.length) && !FamilyTree.isNEU(e) && "string" == typeof e && (-1 != e.indexOf("balkan_group_dotted_") || -1 != e.indexOf("balkan_dotted_"))) {
            ...
            if (e = e.substring(i + "_balkan_id_".length),
                t = this.__get(e))
                return t
        }
        return null
                ...
                if (FamilyTree.isNEU(e))
                    ...
                    if (!1 !== this._fireUpdate_addUpdateRemove(d, a)) {
                        ...
                        this.config.roots = [d.addNodesData[0].id],
                            this._draw(!1, FamilyTree.action.insert, {
                                id: c,
        ...
        if (this.canRemove(e)) {
            ...
            if (Array.isArray(a.pids))
                for (var l = 0; l < a.pids.length; l++) {
                    ...
                    if (o)
                        -1 != (d = o.pids.indexOf(a.id)) && (o.pids.splice(d, 1),
                            n.push(o))
                }
    ...
    FamilyTree.prototype._fireUpdate_addUpdateRemove = function (e, t) {
        ...
        return FamilyTree.isNEU(e.removeNodeId) || this.remove(e.removeNodeId),
            !0
    }
    ,
        ...
        if (this.config.interactive) {
            ...
            this.config.enableTouch || FamilyTree.isMobile() ? (this._addEvent(e, "touchstart", this._globalMouseDownHandler),
                this._addEvent(e, "touchend", this._globalClickHandler)) : (this._addEvent(e, "mousedown", this._globalMouseDownHandler),
                    ...
                    this.config.mouseScrool != FamilyTree.action.zoom && this.config.mouseScrool != FamilyTree.action.ctrlZoom || (this._addEvent(e, "DOMMouseScroll", this._mouseScrollHandler),
    ...
    FamilyTree._intersects = function (e, t, i) {
        ...
        var o, s, d, c = t.p, m = t.q, p = t.r, h = t.s;
        return 0 !== (o = (n - r) * (h - m) - (p - c) * (l - a)) && (s = ((a - l) * (p - r) + (n - r) * (h - a)) / o,
        ...
        this.obj.element.appendChild(a.element),
            ...
            this.obj.element.querySelector("[data-edit-from-save]").addEventListener("click", (function (t) {
                ...
                if (!1 !== i) {
                    ...
                    if (!1 === FamilyTree.events.publish("save", [r, l]))
                        return;
                    r.obj.updateNode(l.data, null, !0),
                        r.hide()
                }
            }
            ));
    ...
    FamilyTree.editUI.prototype.content = function (e, t, i, r, a) {
        var n, l = this.obj.config.editForm.readOnly, o = JSON.parse(JSON.stringify(this.obj.config.editForm.elements)), s = this.obj.config.editForm.addMore, d = this.obj.config.editForm.saveAndCloseBtn, c = this.obj.config.editForm.cancelBtn, m = this.obj.config.editForm.buttons, p = this.obj.config.editForm.titleBinding, h = this.obj.config.editForm.photoBinding, f = this.obj.getNode(e), u = this.obj._get(e), y = FamilyTree.t(f.templateName, f.min, this.obj.getScale()), g = u[p], T = u[h];
        ...
        FamilyTree.isNEU(g) && (g = ""),
            T = FamilyTree.isNEU(T) ? FamilyTree.icon.user(150, 150, "#8C8C8C", 0, 0) : `<img style="width: 100%;height:100%;border-radius: 50%;" src="${T}"></img>`;
        var w = !t
            , k = t ? "display:none;" : ""
            , S = t || !s ? "display:none;" : ""
        ...
        if (I.setAttribute("data-bft-edit-form", ""),
            ...
            for (b = 0; b < f.tags.length; b++)
                I.classList.add(f.tags[b]);
    ...
    FamilyTree.menuUI.prototype._show = function (e, t, i, r, a) {
        ...
        if (!1 === FamilyTree.events.publish("show", [this, o]))
            return !1;
                ...
                (s = f[u]).addEventListener("click", (function (e) {
                    ...
                    if (void 0 === a[l].onClick)
                        if ("add" === l) {
                            ...
                            "remove" === l ? n.obj.removeNode(i, null, !0) : "svg" === l ? n.obj.exportSVG({
        ...
        if (!FamilyTree.isNEU(a.nodeCircleMenuButton)) {
            ...
            if (FamilyTree.isNEU(h) || h.getAttribute(FamilyTree.attr.control_node_circle_menu_wrraper_id) != e) {
                ...
                for (var y = 0, g = Object.keys(f.menu).length, T = 2 * a.nodeCircleMenuButton.radius + 4, b = 2 * Math.PI * T, v = b / g - (2 * a.nodeCircleMenuButton.radius + 2); v < 0;)
                    T += 8,
                        v = (b = 2 * Math.PI * T) / g - (2 * a.nodeCircleMenuButton.radius + 2);
                ...
                this._linesInterval.push(FamilyTree.animate(p[0], {
                    ...
                    this._linesInterval.push(FamilyTree.animate(p[1], {
                        x1: -a.nodeCircleMenuButton.radius / 2,
                        y1: 0,
                        x2: a.nodeCircleMenuButton.radius / 2,
                        y2: 0
                    ...
                    this._linesInterval.push(FamilyTree.animate(p[2], {
                        x1: -a.nodeCircleMenuButton.radius / 2,
                        y1: 6,
                        x2: a.nodeCircleMenuButton.radius / 2,
                        y2: 6
    ...
    FamilyTree._menuPosition = function (e, t, i) {
        var r = e.getBoundingClientRect()
            ...
            , l = r.left - a.left
            , o = r.top - a.top;
        return r.top + n.height > a.top + a.height && (o -= n.height),
    ...
    FamilyTree.wrapText = function (e, t) {
        ...
        var a, n, l = (new DOMParser).parseFromString(t, "text/xml").getElementsByTagName("text")[0], o = parseFloat(l.getAttribute("x")), s = parseFloat(l.getAttribute("y")), d = l.getAttribute("text-anchor"), c = l.getAttribute(FamilyTree.attr.width), m = l.getAttribute(FamilyTree.attr.text_overflow), p = "http://www.w3.org/2000/svg", h = r.getElementsByTagName("svg")[0].getElementsByTagName("text")[0];
        m || (m = "ellipsis");
        var f = m.split("-");
        ...
        if (-1 != m.indexOf("multiline")) {
            ...
            for (var F = 1, x = 1; x < g.length; x++) {
                ...
                if (b.firstChild.data += " " + g[x],
                    b.getComputedTextLength() > c) {
                    if (b.firstChild.data = b.firstChild.data.slice(0, _),
                        F++,
                        a && F > a) {
            ...
            this._draw(!1, FamilyTree.action.exporting, r, (function (r) {
                ...
                if ("svg" == e.ext)
                    if (t)
                        ...
                        if (d && (o.styles += d.outerHTML),
                            o.styles && (a.childNodes[0].insertAdjacentHTML("afterbegin", o.styles),
                    ...
                    i._pages(e, a.querySelector("svg"), (function (r) {
                        ...
                        if (o && (n.styles += o.outerHTML),
                            !1 === l)
                            return !1;
                        t || FamilyTree.loading.show(i),
                            t ? t(i, n, a.querySelector("svg")) : (n = JSON.stringify(n),
    ...
    FamilyTree.prototype.exportCSV = function (e) {
        ...
        if (!1 === FamilyTree.events.publish("exportend", [this, l]))
            return !1;
    ...
    FamilyTree.prototype._defaultExportProfileOptions = function (e, t) {
        return (FamilyTree.isNEU(e) || FamilyTree.isNEU(e.id)) && console.error("options.id is not defilned"),
            "svg" == t ? (e.ext = "svg",
                e.mime = "image/svg+xml") : "pdf" == t ? (e.mime = "application/pdf",
                    e.ext = "pdf") : "png" == t && (e.mime = "image/png",
                        e.ext = "png"),
        ...
        return {
            ...
            publish: function (t, i) {
                if (e[t]) {
                    ...
                    if (r.length > 0) {
                        var l = !0;
                        for (a = 0; a < r.length && (1 == i.length ? l = r[a](i[0]) && l : 2 == i.length ? l = r[a](i[0], i[1]) && l : 3 == i.length ? l = r[a](i[0], i[1], i[2]) && l : 4 == i.length ? l = r[a](i[0], i[1], i[2], i[3]) && l : 5 == i.length && (l = r[a](i[0], i[1], i[2], i[3], i[4]) && l),
                            !1 !== l); a++)
                            ;
                        return l
                    }
            ...
            t.onchange = function (t) {
                ...
                r.onload = function () {
                    ...
                    FamilyTree._importSetColumnNames(n, (function (t) {
                        ...
                        0 != FamilyTree.events.publish("import", [e, d]) && (e.config.nodes = d.nodes,
                            e.draw())
                    }
                    ))
                }
        ...
        t.setAttribute("type", "file"),
            ...
            t.onchange = function (t) {
                ...
                r.onload = function () {
                    ...
                    0 != FamilyTree.events.publish("import", [e, i]) && (e.config.nodes = i,
                        e.draw())
                }
                    ,
                    r.readAsText(i.files[0])
    ...
    FamilyTree.prototype._globalClickHandler = function (e, t) {
        ...
        for (var o = t.target; o != e;) {
            ...
            if (o.hasAttribute(FamilyTree.attr.node_id)) {
                s = o.getAttribute(FamilyTree.attr.node_id),
                    d = this.getNode(s);
                ...
                , v = function (t) {
                    if (h) {
                        ...
                        if (s.left || s.right || s.up || s.down) {
                            p.classList && (p.classList.remove("bft-cursor-grab"),
                            ...
                            for (l.moveEnd(),
                                p.classList && (p.classList.add("bft-cursor-grab"),
                            ...
                            if (u[4] = y + M,
                                u[5] = g + L,
                                !e._dragEventFired && (Math.abs(i.x - h.x) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(i.y - h.y) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE))
                                !1 === FamilyTree.events.publish("drag", [l.nodeCircleMenuUI, {
                                    from: C,
                                    menuItem: n,
                                    menuItemName: a
                                }]) && F(),
                ...
                , F = function (t) {
                    if (l.moveEnd(),
                        ...
                        return p.removeChild(f),
                            ...
                            void (e._dragEventFired && FamilyTree.events.publish("drop", [l.nodeCircleMenuUI, {
                                from: s.id,
                                menuItemName: a,
                                menuItem: n
                            }]));
            ...
            var y = function (e, t) {
                    ...
                    if (c) {
                        ...
                        if (g.left || g.right || g.up || g.down) {
                            ...
                            if ("draging" == l && (l = null,
                                ...
                                !s.canUpdateLink(n.id, l) && d.classList ? (d.classList.remove("bft-cursor-grab"),
                                    d.classList.remove("bft-cursor-move"),
                                    d.classList.remove("bft-cursor-copy"),
                ...
                , T = function (t) {
                    if (s.moveEnd(),
                        ...
                        n.id == l || null == l)
                        return e._dragEventFired && FamilyTree.events.publish("drop", [s, n.id, void 0, u]),
                            d.removeChild(u),
                ...
                FamilyTree.isNEU(i) && (i = FamilyTree.anim.inSin),
                    ...
                    this._moveInterval = setInterval((function () {
                        ...
                        e.left ? (o++,
                            ...
                            c.xWithoutScale = o * FamilyTree.MOVE_STEP) : e.right && (o++,
                                c.x = -o * FamilyTree.MOVE_STEP / l,
    ...
    FamilyTree.searchUI.prototype._initSearchFields = function () {
        ...
        if (null == this.obj.config.searchFieldsAbbreviation) {
            ...
            for (e = 0; e < this._searchFields.length; e++) {
                for (var i = this._searchFields[e], r = 0, a = i.slice(0, r + 1).toLowerCase(); this._searchFieldsAbbreviation[a];)
                    r++,
        ...
        if (this._searchAfterEnterPress = !1,
            ...
            e = `<table border="0" cellspacing="0" cellpadding="0">\n                        <tbody>\n                            ${function () {
                for (var e = "", r = 0; r < t.lastSearch.length && !(r >= FamilyTree.SEARCH_RESULT_LIMIT); r++) {
                    ...
                    var o = ""
                        , s = "";
                    t.obj.config.searchDisplayField == a.__searchField ? o = a.__searchMarks : t.obj.config.searchDisplayField ? (o = a[t.obj.config.searchDisplayField],
                        FamilyTree.isNEU(o) && (o = ""),
                        s = a.__searchMarks) : o = a.__searchMarks,
    ...
    FamilyTree.manager._initNode = function (e, t, i, r, a, n, l) {
        ...
        for (var h = 0; h < e.childrenIds.length; h++) {
            ...
            if (FamilyTree.manager._setCollpasedProperty(f, p, c, a, d, r, m),
                !f.collapsed) {
                if (f.parent = e,
                    null != f.ppid) {
                    var u = t[f.ppid];
    ...
    FamilyTree.manager.__createNodes = function (e, t, i, r, a, n, l, o) {
        for (var s = [], d = FamilyTree._addDottedLines(i), c = 0; c < d.length; c++) {
            var m, p = d[c];
            m = FamilyTree.STRING_TAGS ? p.tags ? p.tags.split(",") : [] : Array.isArray(p.tags) ? p.tags.slice(0) : [],
        ...
        for (c = 0; c < s.length; c++) {
            ...
            if (T || (u.stpid = null),
                ...
                var v = n ? n[T.id] : null;
                v && (T.min = v.min),
                    T.stChildrenIds.push(u.id)
            } else
                b ? (g && (u.collapsed = g.collapsed,
                    u.min = g.min),
                    b.childrenIds.push(u.id)) : (g && (u.collapsed = g.collapsed,
                        u.min = g.min),
                        t.push(u),
                        l.push(u.id));
    ...
    FamilyTree.manager._createNodes = function (e) {
        var t = e.manager.config
            ...
            , s = []
            , d = [];
        if (FamilyTree.manager.__createNodes(o, s, t, r, a, n, d, e),
            null != t.roots) {
            s = [];
        ...
        r == FamilyTree.action.exporting && null != a.id && ((g = o[a.id]) && (g.pid = null,
            s = [g]));
        var y = [];
        ...
        if (r == FamilyTree.action.collapse && a && Array.isArray(a.expandIds) && Array.isArray(a.collapseIds))
            for (c = 0; c < a.ids.length; c++) {
                if (a.expandIds.has(a.collapseIds[c]))
                    ...
                    (g = o[a.collapseIds[c]]) && (g.collapsed = !0)
            }
        ...
        for (c = 0; c < C.length; c++) {
            ...
            for (F = 0; F < g.children.length; F++) {
                (z = g.children[F]).isAssistant ? I.push(z.id) : -1 != z.tags.indexOf("right-partner") ? (z.isPartner = 1,
                    z.children = [],
                    N.push(z.id)) : -1 != z.tags.indexOf("left-partner") ? (z.isPartner = 2,
                        z.children = [],
                        A.push(z.id)) : -1 == z.tags.indexOf("partner") || M % 2 ? -1 != z.tags.indexOf("partner") && M % 2 ? (z.isPartner = 2,
                            z.children = [],
                            A.push(z.id),
                            M++) : z.parentPartner ? (E[z.parentPartner.id] || (E[z.parentPartner.id] = []),
                                E[z.parentPartner.id].push(z.id)) : I.push(z.id) : (z.isPartner = 1,
                                    z.children = [],
                                    N.push(z.id),
                                    M++)
            }
            ...
            for (F = 0; F < N.length; F++) {
                ...
                for (var D = 0; D < z.childrenIds.length; D++)
                    P.push(z.childrenIds[D])
            }
            var R = [];
            for (F = 0; F < A.length; F++) {
                E[(z = o[A[F]]).id] ? g.children.push(z) : g.children.splice(0, 0, z);
                for (D = 0; D < z.childrenIds.length; D++)
                    R.push(z.childrenIds[D])
            }
            for (F = 0; F < R.length; F++) {
                (z = o[R[F]]).collapsed || (z.parentPartner = z.parent,
                    z.parent = g,
            ...
            for (F = A.length - 1; F >= 0; F--)
                if (E[A[F]])
                    for (u = 0; u < E[A[F]].length; u++)
                        g.children.push(o[E[A[F]][u]]),
                            L++,
                            -1 == B.indexOf(A[F]) && B.push(A[F]);
            ...
            for (F = 0; F < N.length; F++)
                if (E[N[F]])
                    for (u = 0; u < E[N[F]].length; u++)
                        g.children.push(o[E[N[F]][u]]),
                            O++,
                            -1 == U.indexOf(N[F]) && U.push(N[F]);
            for (F = 0; F < P.length; F++) {
                (z = o[P[F]]).collapsed || (z.parentPartner = z.parent,
                    z.parent = g,
                    z.isChildOfPartner = !0,
                    g.children.push(z))
            }
            g.partnerSeparation = Math.max(B.length, U.length) * t.partnerChildrenSplitSeparation + t.minPartnerSeparation,
                I.length || !L || O ? I.length || L || !O ? I.length || 1 != L || 1 != O ? I.length || L || O ? !I.length || L || O ? I.length && (L || O) ? g.hasPartners = 7 : g.hasPartners = 1 : g.hasPartners = 6 : g.hasPartners = 5 : g.hasPartners = 4 : g.hasPartners = 3 : g.hasPartners = 2
        }
        for (c = 0; c < k.length; c++) {
            if ((ae = i[(g = o[k[c]]).lcn ? g.lcn : "base"]).layout == FamilyTree.normal || !S[g.pid])
                for (F = 0; F < g.subLevels; F++) {
                    ...
                    if (FamilyTree.manager._initDinamicNode(j, g.lcn),
                        b = g.parent)
                        (H = b.children.indexOf(g)) > -1 && (b.children.splice(H, 1),
                            b.children.splice(H, 0, j)),
                            j.children.push(g),
                            j.parent = b,
                            g.parent = j,
                            o[j.id] = j
        ...
        for (var $ in w) {
            ...
            FamilyTree.manager._initDinamicNode(j, b.lcn, !0),
                o[j.id] = j;
            var X = [];
            for (F = b.children.length - 1; F >= 0; F--) {
                (z = b.children[F]).isAssistant ? (z.parent = null,
                    b.children.splice(F, 1),
                    X.splice(0, 0, z.id)) : z.isPartner || (z.parent && S[z.parent.id] && j && z.parent.id != j.id && (Object.defineProperty(S, j.id, Object.getOwnPropertyDescriptor(S, z.parent.id)),
                ...
                if ((ae = i[b.lcn ? b.lcn : "base"]).layout == FamilyTree.mixed || ae.layout == FamilyTree.tree || ae.layout == FamilyTree.treeRightOffset || ae.layout == FamilyTree.treeLeftOffset || te)
                    if (ie.pnode = b,
                        ...
                        for (c = ie.childrenIds.length - 1; c >= 0; c--) {
                            for (z = o[ie.childrenIds[c]],
                                F = 0; F < b.children.length; F++)
    ...
    FamilyTree.manager.getAllFields = function (e) {
        ...
        for (i = 0; i < e.nodes.length; i++)
            for (var r in e.nodes[i])
                r !== FamilyTree.ID && r !== FamilyTree.TAGS && r !== FamilyTree.NODES && r !== FamilyTree.PID && r !== FamilyTree.STPID && (e.nodeBinding[r] || t.has(r) || t.push(r));
        return t
    }
    ,
    ...
    FamilyTree.manager._getResponse = function (e, t, i, r, a, n, l, o, s, d, c, m, p, h, f) {
        ...
        if (g.top = o - r.padding,
            ...
            if (_ - 2 * r.padding >= n - o)
                ...
                switch ((k = -(_ / 2 - (n - o) / 2)) > -r.padding && (k = -r.padding),
                r.orientation) {
                    case FamilyTree.orientation.bottom:
                    case FamilyTree.orientation.bottom_left:
        ...
        if (c == FamilyTree.action.insert || c == FamilyTree.action.expand || c == FamilyTree.action.collapse || c == FamilyTree.action.update || c == FamilyTree.action.centerNode || c == FamilyTree.action.maximize) {
            ...
            if (c == FamilyTree.action.insert && m && null != m.insertedNodeId && null != m.insertedNodeId)
                ...
                C = p[m.id],
                    C = FamilyTree.manager._getMostDeepChild(C, p);
    ...
    FamilyTree.manager._iterate2 = function (e, t, i, r, a, n, l, o, s, d) {
        if (FamilyTree.manager._isVisible(e, i, r, a)) {
            ...
            null != c && null != c.x && null != c.y && (c.x == e.x && c.y == e.y || (d[0].push(e.id),
                d[1].push({
        ...
        if ((e.groupDottedLines.length || e.dottedLines.length) && (t = JSON.parse(JSON.stringify(t))),
            ...
            for (var i = [], r = 0; r < e.groupDottedLines.length; r++) {
                ...
                for (l = 0; l < t.length; l++)
                    if (t[l].id == a.from) {
                        if ((c = JSON.parse(JSON.stringify(t[l]))).id = `balkan_group_dotted_ ${a.rootId}_balkan_id_ ${t[l].id}`,
        ...
        if (e.dottedLines.length)
            for (r = 0; r < e.dottedLines.length; r++) {
                ...
                for (l = 0; l < t.length; l++)
                    if (t[l].id == d.from) {
                        var c;
                        if ((c = JSON.parse(JSON.stringify(t[l]))).id = `balkan_dotted_ ${d.rootId}_balkan_id_ ${t[l].id}`,
    ...
    FamilyTree.manager.__createNodes = function (e, t, i, r, a, n, l, o) {
        for (var s = i.nodes, d = [], c = {}, m = {}, p = 0; p < s.length; p++) {
            var h, f = s[p];
            h = FamilyTree.STRING_TAGS ? f.tags ? f.tags.split(",") : [] : Array.isArray(f.tags) ? f.tags.slice(0) : [],
        ...
        for (p = 0; p < l.length; p++)
            for (var F = 0; F < l.length; F++)
                if (F != p) {
                    ...
                    w && (l[p] = x.concat(_).unique(),
                        l[F] = [])
                }
        for (p = l.length - 1; p >= 0; p--)
            l[p].length || l.splice(p, 1);
    ...
    FamilyTree.manager._iterateFT = function (e, t, i, r, a, n, l, o, s) {
        ...
        if (p || (c.stpid = null),
            h ? f && (h.tags.has("partner") || h.tags.has("left-partner") || h.tags.has("right-partner")) ? (c.pid = f.id,
                d = f,
                c.ppid = h.id) : (c.pid = h.id,
                    d = h,
                    f && (c.ppid = f.id)) : f ? h && (f.tags.has("partner") || f.tags.has("left-partner") || f.tags.has("right-partner")) ? (c.pid = h.id,
                        d = h,
            ...
            var u = a ? a[p.id] : null;
            u && (p.min = u.min),
                p.stChildrenIds.push(c.id)
        } else
            h || f ? (m && (c.collapsed = m.collapsed,
                c.min = m.min),
        ...
        for (var y = 0; y < c.pids.length; y++) {
            ...
            if (g) {
                g.pid = c.id;
                var T = a ? a[g.id] : null;
                if (T && (g.collapsed = T.collapsed,
                    g.min = T.min),
                    l == FamilyTree.action.init && (g.min = FamilyTree._getMin(g, s)),
                    o && m && T && o.id == c.id ? T.hasPartners && 1 == m.isPartner ? g.tags.push("left-partner") : T.hasPartners && 2 == m.isPartner || 1 == m.isPartner ? g.tags.push("right-partner") : 2 == m.isPartner ? g.tags.push("left-partner") : g.tags.push("partner") : T && 2 == T.isPartner ? g.tags.push("left-partner") : T && 1 == T.isPartner ? g.tags.push("right-partner") : g.tags.push("partner"),
    ...
    FamilyTree.ui = {
        ...
        node: function (e, t, i, r, a, n, l, o, s, d) {
            ...
            for (var h in l) {
                ...
                if (p.value = f,
                    p.element = c[h],
                    p.name = u,
                    !1 !== FamilyTree.events.publish("field", [d, p]) && null != p.value && null != p.value && null != p.element) {
        ...
        expandCollapseBtn: function (e, t, i, r, a) {
            ...
            if (r !== FamilyTree.action.exporting && !t.isSplit) {
                ...
                if (t.childrenIds.length > 0) {
                    ...
                    if (o -= d.expandCollapseSize / 2,
                        s -= d.expandCollapseSize / 2,
                        e.getCollapsedIds(t).length ? (n += FamilyTree.expcollOpenTag.replace("{id}", t.id).replace("{x}", o).replace("{y}", s),
                            n += d.plus,
                            n += FamilyTree.grCloseTag) : (n += FamilyTree.expcollOpenTag.replace("{id}", t.id).replace("{x}", o).replace("{y}", s),
                                n += d.minus,
        ...
        link: function (e, t, i, r, a, n) {
            ...
            if (e.hasPartners) {
                ...
                for (var u = 0; u < e.children.length; u++) {
                    (y = e.children[u]).parentPartner ? (f.ppnodes[y.id] = y.parentPartner,
                        f.ids.push(y.id),
                        1 == y.parentPartner.isPartner ? (-1 == f.rightIds.indexOf(y.parentPartner.id) && f.rightIds.push(y.parentPartner.id),
                            f.indexes[y.id] = f.rightIds.indexOf(y.parentPartner.id),
                            f.firstRight || (f.firstRight = y)) : 2 == y.parentPartner.isPartner && (-1 == f.leftIds.indexOf(y.parentPartner.id) && f.leftIds.push(y.parentPartner.id),
                                f.indexes[y.id] = f.leftIds.indexOf(y.parentPartner.id),
                                f.lastLeft = y)) : y.isPartner || (f.lastLeft = y,
                ...
                for (var C in t.config.linkBinding) {
                    ...
                    if (N) {
                        ...
                        k.value = A,
                            k.element = s[C],
                            k.name = I,
                            !1 !== FamilyTree.events.publish("label", [t, k]) && (FamilyTree.isNEU(k.value) || FamilyTree.isNEU(k.element) || (S += k.element.replace("{val}", k.value)))
                    }
                }
                "" != S && (S = FamilyTree.linkFieldsOpenTag.replace("{x}", T.x).replace("{y}", T.y).replace("{rotate}", 0) + S + FamilyTree.grCloseTag,
                    d.push(S)),
        ...
        _roundedEdge: function (e, t, i, r, a, n) {
            var l, o, s, d = FamilyTree.LINK_ROUNDED_CORNERS, c = 0;
            return e == i && e == a || t == r && t == n ? (l = s = i,
                o = c = r) : (e != a && i == a && (l = s = i,
                    o = r,
                    t < n ? c = r + d : t > n && (c = r - d)),
        ...
        __linkPpBottomTop: function (e, t, i, r, a, n) {
            var l = 0;
            return 1 == n.isPartner ? (l = n.x - t.partnerSeparation / 2 + e.indexes[i.id] * e.partnerChildrenSplitSeparation - (e.rightIds.length - 1) * e.partnerChildrenSplitSeparation / 2,
                e.lastLeft && l < e.lastLeft.x + e.lastLeft.w / 2 ? l < i.x + i.w / 2 ? r -= (e.indexes[i.id] + 1) * a : r -= (e.rightIds.length - e.indexes[i.id]) * a : l < i.x + i.w / 2 ? r += (e.rightIds.length - e.indexes[i.id]) * a : r += (e.indexes[i.id] + 1) * a) : 2 == n.isPartner && (l = n.x + n.w + t.partnerSeparation / 2 + e.indexes[i.id] * e.partnerChildrenSplitSeparation - (e.leftIds.length - 1) * e.partnerChildrenSplitSeparation / 2,
                    e.firstRight && l > e.firstRight.x + e.firstRight.w / 2 ? l < i.x + i.w / 2 ? r -= (e.indexes[i.id] + 1) * a : r -= (e.leftIds.length - e.indexes[i.id]) * a : l < i.x + i.w / 2 ? r += (e.leftIds.length - e.indexes[i.id]) * a : r += (e.indexes[i.id] + 1) * a),
            {
                x: l,
                mid: r
            }
        ...
        __linkPpLeftRight: function (e, t, i, r, a, n) {
            var l = 0;
            return 1 == n.isPartner ? (l = n.y - t.partnerSeparation / 2 + e.indexes[i.id] * e.partnerChildrenSplitSeparation - (e.rightIds.length - 1) * e.partnerChildrenSplitSeparation / 2,
                e.lastLeft && l < e.lastLeft.y + e.lastLeft.h / 2 ? l < i.y + i.h / 2 ? r -= (e.indexes[i.id] + 1) * a : r -= (e.rightIds.length - e.indexes[i.id]) * a : l < i.y + i.h / 2 ? r += (e.rightIds.length - e.indexes[i.id]) * a : r += (e.indexes[i.id] + 1) * a) : 2 == n.isPartner && (l = n.y + n.h + t.partnerSeparation / 2 + e.indexes[i.id] * e.partnerChildrenSplitSeparation - (e.leftIds.length - 1) * e.partnerChildrenSplitSeparation / 2,
                    e.firstRight && l > e.firstRight.y + e.firstRight.h / 2 ? l < i.y + i.h / 2 ? r -= (e.indexes[i.id] + 1) * a : r -= (e.leftIds.length - e.indexes[i.id]) * a : l < i.y + i.h / 2 ? r += (e.leftIds.length - e.indexes[i.id]) * a : r += (e.indexes[i.id] + 1) * a),
            {
                y: l,
                mid: r
            }
        ...
        if ((this.config.mouseScrool == FamilyTree.action.xScroll || this.config.mouseScrool == FamilyTree.action.scroll) && this.bar) {
            ...
            !function (e, i, r) {
                ...
                function n() {
                    ...
                    Math.ceil(t.bar.scrollLeft) == Math.ceil(t.pos) ? a = !1 : (t.bar.scrollLeft += e,
                        l(n))
                }
                e.addEventListener("wheel", (function (e) {
                    ...
                    else if (t.config.mouseScrool == FamilyTree.action.scroll && !(r = e.shiftKey ? e.deltaY || e.wheelDeltaY : e.deltaX || e.wheelDeltaX))
                        return;
                    r = -r,
        ...
        if (this.config.mouseScrool == FamilyTree.action.yScroll || this.config.mouseScrool == FamilyTree.action.scroll) {
            ...
            !function (e, i, r) {
                ...
                function n() {
                    ...
                    Math.ceil(t.bar.scrollTop) == Math.ceil(t.pos) ? a = !1 : (t.bar.scrollTop += e,
                        l(n))
                }
                e.addEventListener("wheel", (function (e) {
                    var r = 0;
                    ...
                    else if (t.config.mouseScrool == FamilyTree.action.scroll && !(r = e.shiftKey ? e.deltaX || e.wheelDeltaX : e.deltaY || e.wheelDeltaY))
                        return;
                    r = -r,
                        r = Math.max(-1, Math.min(1, r)),
                        t.pos += -r * i;
    ...
    FamilyTree.pdfPrevUI.show = function (e, t) {
        ...
        var a, n, l, o = e.element.querySelector("#bft-ppdf-size"), s = e.element.querySelector("#bft-ppdf-layout"), d = e.element.querySelector("#bft-ppdf-scale"), c = e.element.querySelector("#bft-ppdf-margin"), m = e.element.querySelector("#bft-ppdf-header"), p = e.element.querySelector("#bft-ppdf-footer");
        o.value = t.format,
            s.value = t.landscape,
            d.value = t.scale,
            c.value = t.margin,
    ...
    FamilyTree.pdfPrevUI._handler = function (e, t, i) {
        ...
        for (var s = o.querySelector("svg"), d = e.element.querySelector("#bft-ppdf-content"), c = 0; c < a.length; c++) {
            ...
            a[c].footer && (f = a[c].footer),
                ...
                a[c].html ? p.write(FamilyTree._exportHtml(a[c].html, t.styles, r, a[c].innerSize.w, a[c].innerSize.h, h, f, e.config.mode)) : (s.setAttribute("viewBox", a[c].vb),
                    p.write(FamilyTree._exportHtml(o.innerHTML, t.styles, r, a[c].innerSize.w, a[c].innerSize.h, h, f, e.config.mode)));
    ...
    FamilyTree.prototype._clink = function (e, t) {
        for (var i, r, a, n, l, o = "", s = 0; s < this.config.clinks.length; s++) {
            ...
            if (c && -1 != t.res.visibleNodeIds.indexOf(c.id) && (m && -1 != t.res.visibleNodeIds.indexOf(m.id))) {
                ...
                o += ("<g " + FamilyTree.attr.c_link_from + '="{from}" ' + FamilyTree.attr.c_link_to + '="{to}">').replace("{from}", c.id).replace("{to}", m.id) + k.link.replaceAll("{d}", C) + '<path stroke="transparent" stroke-width="15" fill="none" d="' + C + '" />',
    ...
    FamilyTree.prototype._slinks = function (e, t) {
        ...
        function n(t, n, l) {
            ...
            if (t.sl == n.sl)
                ...
                for (var y = t; null == d;) {
                    var g = !1
                        ...
                        , b = T.leftNeighbor
                        , v = T.rightNeighbor;
                    if (T.id == n.id ? d = T : FamilyTree._intersects(T, u, e.config) && (u = FamilyTree._addPoint(T, s, e.config, u, c),
                        g = !0),
                        T.id != n.id) {
                        for (; b;) {
                            if (b.id == n.id) {
                            ...
                            FamilyTree._intersects(b, u, e.config) && (u = FamilyTree._addPoint(b, s, e.config, u, c),
                                g = !0),
                                b = b.leftNeighbor
                        }
                        for (; v;) {
                            ...
                            FamilyTree._intersects(v, u, e.config) && (u = FamilyTree._addPoint(v, s, e.config, u, c),
                                g = !0),
                                v = v.rightNeighbor
                        }
                    }
                    if (!g) {
                        var F = s[s.length - 1][0]
                            , x = 0;
                        if (T.parent)
                            switch (f = p.levelSeparation,
                            T.parent.layout != FamilyTree.mixed && T.parent.layout != FamilyTree.tree || (f = p.mixedHierarchyNodesSeparation),
                            p.orientation) {
                                case FamilyTree.orientation.top:
                                case FamilyTree.orientation.top_left:
                ...
                switch (h = FamilyTree.t(d.templateName, d.min, r),
            ...
            if (o.label) {
                ...
                i += h.label.replace("{x}", S.x).replace("{y}", S.y + M).replace("{val}", o.label)
            }
            var L = t.id
                , O = n.id;
            l && (L = n.id,
                O = t.id),
                i += ("<g " + FamilyTree.attr.s_link_from + '="{from}" ' + FamilyTree.attr.s_link_to + '="{to}">').replace("{from}", L).replace("{to}", O) + h.link.replaceAll("{d}", N) + '<path stroke="transparent" stroke-width="15" fill="none" d="' + N + '" />',
    ...
    FamilyTree.events.on("redraw", (function (e, t) {
        if (e.config.miniMap) {
            if (e.manager.action != FamilyTree.action.move) {
                ...
                var r, a, n, l, o = e.element.querySelector('[data-id="mini-map-focus"]'), s = !1, d = null;
                o.onmousedown = function (e) {
                    var t, n, l, d = o.getBoundingClientRect(), c = d.left, m = d.top;
    ...
    FamilyTree._search.addNodeToResult = function (e, t, i, r, a, n) {
        var l = {};
        l.id = i.id,
            FamilyTree.isNEU(i[n]) || (l[n] = i[n]);
        for (var o = 0; o < t.length; o++) {
            var s = t[o];
            FamilyTree.isNEU(i[s]) || FamilyTree.isNEU(l[s]) && (l[s] = i[s])
        }
        null != r && (FamilyTree.isNEU(l.__score) && (l.__score = r.__score),
    ...
    FamilyTree.state._put = function (e, t, i, r, a, n, l, o) {
        if (o) {
            ...
            o.writeToIndexedDB && (d.id = o.name,
    ...
    FamilyTree.prototype.magnify = function (e, t, i, r, a) {
        ...
        if (n || l) {
            ...
            if (o && (null != o.timer && clearInterval(o.timer),
                ...
                if ("KeyF" == t.code)
                    ...
                    if (s = this.getNode(a.pid)) {
                        ...
                        if (++l < s.childrenIds.length) {
                            ...
                            this._keyNavigationActiveNodeId = o,
                                this.center(o)
                        }
                    }
    ...
    FamilyTree.input.validate = function (e) {
        ...
        return a && "" == t.value ? (i.innerHTML += '<span class="bft-validation-error-message">&nbsp;' + a + "</span>",
            ...
            !1) : n && !FamilyTree.input.validatePassword(t.value) ? (i.innerHTML += '<span class="bft-validation-error-message">&nbsp;' + n + "</span>",
                t.classList.add("bft-validation-error"),
                !1) : l && !FamilyTree.input.isValidEmail(t.value) ? (i.innerHTML += '<span class="bft-validation-error-message">&nbsp;' + l + "</span>",
                    t.classList.add("bft-validation-error"),
                    !1) : !(o && !FamilyTree.input.isValidEmails(t.value)) || (i.innerHTML += '<span class="bft-validation-error-message">&nbsp;' + o + "</span>",
                        t.classList.add("bft-validation-error"),
                        !1)
    }
    ,
    ...
    FamilyTree.prototype.showTreeMenu = function (e) {
        ...
        if (n)
            ...
            c.mid = p.id,
                a ? (a.pids = [p.id],
                    p.pids = [a.id],
                    p._ft_data.pids = [a.id]) : p.pids = ["_ft_father"],
                m.push(p)
        }
        if (a)
            m.push(a);
            ...
            c.fid = h.id,
                n ? (n.pids = [h.id],
                    h.pids = [n.id],
                    h._ft_data.pids = [n.id]) : h.pids = ["_ft_mother"],
                m.push(h)
        }
        ...
        if ("male" == c.gender ? (f.templateName = "wife",
            ...
            for (s = 0; s < c.pids.length; s++) {
                ...
                for (var g = 0; g < o.length; g++)
                    o[g].mid != c.pids[s] && o[g].fid != c.pids[s] || (o[g].mid = void 0,
                        o[g].fid = void 0,
        ...
        for (g = 0; g < o.length; g++)
            (o[g].fid == c.id && FamilyTree.isNEU(o[g].mid) || o[g].mid == c.id && FamilyTree.isNEU(o[g].fid)) && (o[g].fid == c.id ? o[g].mid = "_ft_partner_for_single_child" : o[g].mid == c.id && (o[g].fid = "_ft_partner_for_single_child"),
                m.push(o[g]),
                T.push(o[g].id));
        if (T.length) {
            var b = {
            ...
            "male" == c.gender ? (b.templateName = "wife",
                b._ft_partnerData.gender = "female") : "female" == c.gender && (b.templateName = "husband",
                    b._ft_partnerData.gender = "male"),
                c.pids.push(b.id),
                m.push(b)
        }
        var v = {
    ...
    FamilyTree.filterUI.prototype.update = function () {
        if (this.instance.config.filterBy) {
            ...
            if ("all" == this.instance.config.filterBy)
                ...
                for (var r in this.instance.config.filterBy)
                    e[r] = {};
            for (var a in e) {
                var n = e[a];
            ...
            c.innerHTML = `<div>${m}</div>`,
                c.addEventListener("click", (function (e) {
                    if (e.target.hasAttribute("data-filter-close") || e.target.hasAttribute("data-filter-field")) {
                        for (var t = e.target.getAttribute("data-filter-field"), i = d.instance.element.querySelectorAll("[data-filter-menu]"), r = 0; r < i.length; r++)
                                ...
                                p[r].addEventListener("change", (function (e) {
                                    ...
                                    if (t) {
                                        ...
                                        if (e.target.hasAttribute("data-all")) {
                                            ...
                                            null != d.filterBy[i][this.name] && (d.filterBy[i][this.name].checked = this.checked);
                                        d.instance.draw()
                                    }
                                }
                                ))
    ...
    FamilyTree.remote._findRegion = function (e) {
        ...
        if (t)
            ...
            for (var i = ["au-e", "au-se", "brs", "ca", "ca-e", "easia", "eus-2", "eus", "fr", "ind", "jp-e", "jp-w", "kr", "n-eu", "se-asia", "s-ind", "uk-s", "uk-w", "us", "us-n-c", "us-s-c", "w-c-us", "w-eu", "w-ind", "w-us-2", "wus"], r = [], a = 0; a < i.length; a++)
                ...
                !function () {
                    ...
                    n.onreadystatechange = function () {
                        if (4 == this.readyState && 200 == this.status) {
                            FamilyTree.localStorage.setItem("funcUrl", t),
                                e(t);
